# Generated by Django 3.0.2 on 2020-02-25 23:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('AC', '0047_auto_20200225_1755'),
    ]

    operations = [
        migrations.AddField(
            model_name='carros',
            name='razon_de_inactividad',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='AC.RazonDeInactividad'),
        ),
